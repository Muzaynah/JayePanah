...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'home.quick.title': 'Quick Help (1 min)',
      'home.quick.subtitle': 'Fast breathing and grounding tools',
      ...
      'calm.corner.subtitle': 'Soothing sounds & calming games',
      'calm.sounds.title': 'Sound Gallery',
      'calm.sounds.subtitle': 'Tap a sound to play • Tap again to stop',
      'calm.sounds.playing': 'Now Playing',
      ...
      'calm.sound.fireplace': 'Crackling Fire',
      'calm.sound.water': 'Water Flowing',
      'calm.sound.cooking': 'Cooking Sounds',
      'calm.sound.rain2': 'Rainy Window',
      'calm.match.title': 'Memory Match',
      'calm.match.subtitle': 'Tap to reveal and match pairs',
      ...
      'calm.color.hold': 'Hold',
      'calm.color.exhale': 'Breathe Out',
    },
    'ur': {
      'app.name': 'جائے پناہ',
      ...
      'home.quick.title': 'فوری مدد (1 منٹ)',
      'home.quick.subtitle': 'تیزی سے سانس اور بنیادی ٹولز',
      ...
      'calm.sound.fireplace': 'آتش خانے کی آواز',
      'calm.sound.water': 'بہتی ہوئی پانی',
      'calm.sound.cooking': 'پکانے کی آوازیں',
      'calm.sound.rain2': 'بارش کی کھڑکی',
      'calm.match.title': 'یادداشت میچ',
      'calm.match.subtitle': 'جوڑوں کو ظاہر کرنے کے لیے ٹیپ کریں',
      ...
      'calm.color.hold': 'روکے رکھیں',
      'calm.color.exhale': 'سانس باہر کریں',
    },
  };
}
